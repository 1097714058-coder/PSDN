...
######################
        ...
        if epoch >= trainer.cmlabel:
            ...
            cluster_label_rgb_ir = torch.gather(cluster_label_rgb_ir, dim=1, index=cluster_label_index.view(-1,1))  
            ...
            update_memory1 = trainer.memory_ir.features[cluster_label_rgb_ir.view(-1)]
            lamda_cm=0.1
